      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-column">
            <h4>Our Services</h4>
            <ul className="footer-links">
              <li><Link to="/services">Education Consulting</Link></li>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              <li>
                <a href="mailto:info@npathways.global">
                  📧 info@npathways.global
                </a>
              </li>
              <li>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            © {new Date().getFullYear()} NPathways Global. All rights reserved. Operated by <strong>Skillinum Falcon LLP</strong>.
          </p>
